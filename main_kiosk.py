...
class MailLightKiosk:
    def __init__(self, root):
        ...
        # --- כפתור "מצב שינה" ידני בלי אימוג'י ---
        self.sleep_button = tk.Button(root, text=get_display("מצב שינה"), font=("Helvetica", 14, "bold"), bg="#f44336", fg="white", activebackground="#d32f2f", activeforeground="white", command=self.go_to_sleep, bd=2, relief=tk.RAISED)
    ...
    def go_to_sleep(self):
        ...
        self.sleep_button.place_forget()
    ...
    def wake_up_system(self, event=None):
        ...
        self.sleep_button.place(relx=0.95, rely=0.92, anchor=tk.SE)
